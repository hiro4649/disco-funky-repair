            ...
            <div className='px-3 z-10'>
                <div className="pt-7">
                    ...
                    <div className='mt-5 text-white/80 leading-[22px] text-[15px]'>
                        ...
                        <div>
                            <p className='text-[#00FFCC] font-semibold mt-5 mb-[0.8rem]'>{t('How It Works')}</p>
                        ...
                        <div>
                            <p className='text-[#00FFCC] font-semibold mt-5 mb-[0.8rem]'>{t('Investor Benefits')}</p>
                        ...
                        <div>
                            <p className='text-[#00FFCC] font-semibold mt-5 mb-[0.8rem]'>{t('Model Differences')}</p>
                            <p>{t('Differences Description')}</p>
                        </div>
                        <div>
                            <p className='text-[#00FFCC] font-semibold mt-5 mb-[0.8rem]'>{t('Future')}</p>
