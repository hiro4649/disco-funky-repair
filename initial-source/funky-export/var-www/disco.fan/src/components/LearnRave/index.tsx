...
const LearnRave = () => {
    ...
    const t = useTranslations('ExploreDISCORAVE')
    useEffect(() => {
        ...
        <div className='mx-auto max-w-[480px] flex'>
            ...
            <div className="px-3 z-10">
                <div className="space-y-[20px] pt-7">
                    ...
                    <div className='text-white leading-[22px] text-[15px]'>
                        <p className='font-semibold text-[#00FFCC] mb-2'> {t('Precision in Market Analysis')} </p>
                        <p className='text-white/80'> {t('Market Analysis Description')} </p>
                    </div>
                    <div className='text-white leading-[22px] text-[15px] '>
                        <p className='font-semibold text-[#00FFCC] mb-2'> {t('Fair and Sustainable')} </p>
                        <p className='text-white/80'> {t('Airdrop Description')} </p>
                    </div>
                    <div className='text-white leading-[22px] text-[15px]'>
                        <p className='font-semibold text-[#00FFCC] mb-2'> {t('Maximizing Returns')} </p>
                    ...
                    <div className="flex items-center justify-center">
                        <p className="mt-7 mb-2 font-saira text-[24px] font-normal leading-[28px] text-[#00FFCC]">
                            {t('DISCO User Guide')}
                        </p>
                    </div>
                    <div className='text-white leading-[22px] text-[15px] '>
                        ...
                        <p className='font-semibold text-[#00FFCC] mb-2'> {t('Features')} </p>
                    ...
                    <div className='text-white leading-[22px] text-[15px] border-b border-[#00FFCC]'>
                        <p className='font-semibold text-[#00FFCC] mb-2'>
                            <span className="inline-block bg-[#333333] rounded-md text-center text-[14px] py-[2px] px-[6px]">{t('Step1')}</span>
                            &nbsp;&nbsp;&nbsp;
                            {t('Hold DISCO Tokens')}
                        </p>
                    </div>
                    ...
                    <div className='text-white leading-[22px] text-[15px] border-b border-[#00FFCC]'>
                        <p className='font-semibold text-[#00FFCC] mb-2'><span className="inline-block bg-[#333333] rounded-md text-center text-[14px] py-[2px] px-[6px]">{t('Step2')}</span>&nbsp;&nbsp;&nbsp;
                            {t('Receive Tickets')}</p>
                    </div>
                    <div className='text-white leading-[22px] text-[15px]'>
                    ...
                    <div className='text-white leading-[22px] text-[15px] border-b border-[#00FFCC]'>
                        <p className='font-semibold text-[#00FFCC] mb-2'><span className="inline-block bg-[#333333] rounded-md text-center text-[14px] py-[2px] px-[6px]"> {t('Step3')} </span>&nbsp;&nbsp;&nbsp;
                            {t('Participate')}</p>
                    </div>
                    <div className='text-white leading-[22px] text-[15px]'>
                    ...
                    <div className='text-white leading-[22px] text-[15px] border-b border-[#00FFCC]'>
                        <p className='font-semibold text-[#00FFCC] mb-2'><span className="inline-block bg-[#333333] rounded-md text-center text-[14px] py-[2px] px-[6px]">{t('Step4')}</span>&nbsp;&nbsp;&nbsp;
                            {t('Claim Prize')} </p>
                    </div>
                    <div className='text-white leading-[22px] text-[15px]'>
                    ...
                    <div className='text-white leading-[22px] text-[15px]'>
                        <p className='font-semibold text-[#00FFCC]'> {t('Daily Tips')} </p>
                    </div>
                    <div className='text-white leading-[22px] text-[15px]'>
