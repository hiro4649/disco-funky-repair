...
const TopLeaderRanking: React.FC<any> = () => {
    ...
    return (
        <>
            <div className="bg-[#1D1B20] p-5 rounded-lg space-y-4 mb-10">
                ...
                <div className="text-xs text-white">
                    <span>
                        If you refer a friend to DISCO, I will give you the ticket you need to enter the airdrop lottery.
                    </span>
                </div>
                ...
                <div className="flex justify-center items-center space-x-6">
                    <ButtonDefault
                        ...
                        customClasses="w-3/6 bg-[#00FFCC]/10 text-[#00FFCC] w-full py-2 border-[0.5px] border-[#00FFCC] rounded-full text-xs shadow-3"
                        leftIconFlag={true}
                    >
                    </ButtonDefault>
                </div>
