...
const SidebarItem = ({ item, pageName, setPageName }: any) => {
  ...
  const activeClass =
    "bg-primary/[.07] text-primary dark:bg-transparent dark:text-[#00FFCC] border-[0.5px] border-[#00FFCC] group relative flex items-center gap-[0.4rem] rounded-[8px] px-2.5 py-[7px] duration-300 ease-in-out";
