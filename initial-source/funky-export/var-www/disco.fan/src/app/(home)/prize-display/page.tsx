"use client";
import Particleground from '@/components/LearnRave/Particleground';
    ...
    return (
        <div className={`${openScreen == true ? "loaded" : ""}`}>
            <div className="min-h-screen bg-gradient-to-br from-yellow-400 via-orange-500 to-red-500">
                ...
                <Particleground />
                <PrizeItemModal
                    iconUrl={prize_image || "https://www.volosui.com/vSUI.png"}
                    tokenSymbol={prize_symbol || "vSUI"}
                    tokenName={prize_name || "Volo SUI"}
