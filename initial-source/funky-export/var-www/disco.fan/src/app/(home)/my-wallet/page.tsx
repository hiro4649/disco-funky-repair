...
export const metadata: Metadata = {
  metadataBase: new URL('https://disco.fan'),
    title: "DISCO RAVE - Daily Airdrop & Cryptocurrency Rewards User Wallet",
    description: "Simply hold DISCO RAVE tokens in your crypto wallet, and enjoy a free daily cryptocurrency airdrop! Experience the ultimate daily crypto reward service! User Wallet.",
    openGraph: {
      type: "website",
      locale: "en_US",
      url: "https://disco.fan",
      title: "DISCO RAVE - Daily Airdrop & Cryptocurrency Rewards User Wallet.",
      description:
        "Simply hold DISCO RAVE tokens in your crypto wallet, and enjoy a free daily cryptocurrency airdrop! Experience the ultimate daily crypto reward service! User Wallet.",
      siteName: "DISCO RAVE",
      images: [
        {
