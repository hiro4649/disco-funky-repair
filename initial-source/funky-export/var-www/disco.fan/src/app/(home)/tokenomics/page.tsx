...
export const metadata: Metadata = {
  ...
  title: "DISCO RAVE - Daily Airdrop & Cryptocurrency Rewards Tokenomics",
  description: "Simply hold DISCO RAVE tokens in your crypto wallet, and enjoy a free daily cryptocurrency airdrop! Experience the ultimate daily crypto reward service! Tokenomics",
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://disco.fan",
    title: "DISCO RAVE - Daily Airdrop & Cryptocurrency Rewards Tokenomics",
    description:
      "Simply hold DISCO RAVE tokens in your crypto wallet, and enjoy a free daily cryptocurrency airdrop! Experience the ultimate daily crypto reward service! Tokenomics",
    siteName: "DISCO RAVE",
    images: [
      {
