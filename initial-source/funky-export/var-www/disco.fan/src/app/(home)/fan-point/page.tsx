...
export const metadata: Metadata = {
  ...
  title: "DISCO RAVE - Daily Airdrop & Cryptocurrency Rewards Fan Points",
  description: "Simply hold DISCO RAVE tokens in your crypto wallet, and enjoy a free daily cryptocurrency airdrop! Experience the ultimate daily crypto reward service! Fan Points",
  openGraph: {
    type: "website",
    url: "https://disco.fan",
    locale: "en_US",
    title: "DISCO RAVE - Daily Airdrop & Cryptocurrency Rewards Fan Points",
    description:
      "Simply hold DISCO RAVE tokens in your crypto wallet, and enjoy a free daily cryptocurrency airdrop! Experience the ultimate daily crypto reward service! Fan Points",
    siteName: "DISCO RAVE",
    images: [
      {
