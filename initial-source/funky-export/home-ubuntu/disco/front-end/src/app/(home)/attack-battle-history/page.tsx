...
export const metadata: Metadata = {
    ...
    title: `Attack Battle history of User in ${process.env.NEXT_PUBLIC_APP_NAME}`,
    description: `Discover the Attack Battle history in your ${process.env.NEXT_PUBLIC_APP_NAME} collection`,
    openGraph: {
      type: "website",
