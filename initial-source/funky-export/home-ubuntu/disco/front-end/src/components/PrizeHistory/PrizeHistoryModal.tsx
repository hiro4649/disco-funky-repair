            ...
            <>
              ...
              <ModalBody className="gap-2 px-2 pb-[0.7rem] pt-2">
                <div className="flex gap-x-2.5">
                  <div className="w-2/4 rounded-lg border-y-[0.5px] border-y-[#666666] bg-secondary px-3 py-2">
                    <p className="text-[12px] leading-[12.1px] text-main ">
                ...
                <div className="relative rounded-lg border-y-[0.5px] border-y-[#666666] bg-secondary px-3 py-2">
                  <p className="text-[12px] leading-[12.1px] text-main">
                    <span className="rounded-[3px] bg-black px-[4px] py-[1px] text-[12px]">
                      CA
                    </span>
                ...
                <div className="rounded-lg border-y-[0.5px] border-y-[#666666] bg-secondary px-3 py-2">
                  <p className="text-[12px] leading-[12.1px] text-main">
                    <span className="rounded-[3px] bg-black px-[4px] py-[1px] text-[12px]">
                      Telegram
                    </span>
