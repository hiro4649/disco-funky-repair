const PrizeIcon = (props: {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="_x32_" x="0px" y="0px" viewBox="0 0 512 512" width={`${width ? width : 24}`} height={`${height ? height : 24}`} className={`${className}`}>
            <g>
