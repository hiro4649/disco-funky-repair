...
const IllustrationHistory = () => {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      ...
      <div className="mb-6 rounded-xl border border-gray-200 bg-white/80 p-4 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:items-end">
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            <ButtonDefault
              ...
              customClasses="bg-gray-900 text-white px-4 py-2 rounded-lg"
            ...
            <tbody>
              {illustrations.map((item) => (
                <tr key={item.id}>
                  ...
                  <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                    {moment.utc(item.createdAt).format("MM/DD/YYYY HH:mm:ss")}
                  </td>
                </tr>
              ))}
            </tbody>
