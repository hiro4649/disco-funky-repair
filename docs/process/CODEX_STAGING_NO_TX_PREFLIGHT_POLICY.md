...
# Staging No-Tx Preflight Policy

Version: v0.9.4

Requires safe evidence for staging domain, HTTPS, backend env, frontend env, proxy, process manager, healthcheck, and secret log scan before no-tx readiness is claimed.
