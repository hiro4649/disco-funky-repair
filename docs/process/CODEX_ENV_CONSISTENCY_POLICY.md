...
# Env Consistency Policy

Version: v0.9.4

Compares docs, validators, deployment guidance, staging/prod preflight descriptions, and target manifest env registries for required environment field drift.
