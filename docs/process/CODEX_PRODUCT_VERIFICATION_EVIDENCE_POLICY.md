...
Evidence must be safe summaries only. Do not store raw logs, payloads, diffs, endpoint values, private paths, production data, personal data, tokens, or secrets.
