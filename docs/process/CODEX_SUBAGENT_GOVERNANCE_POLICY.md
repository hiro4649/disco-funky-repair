...
# Subagent Governance Policy

- Subagent output is role checklist evidence, not raw transcript evidence.
- Security, runtime, architecture, product fit, code quality, and evidence integrity roles are required by risk.
- Subagents cannot approve runtime readiness without oracle evidence.
