...
# Product Baseline Continuity Policy

Version: v0.9.4

Ensures remote baseline results do not disappear, get downgraded to diagnostic-only pass, or merge with candidate regression evidence while moving through harness summaries and artifacts.
