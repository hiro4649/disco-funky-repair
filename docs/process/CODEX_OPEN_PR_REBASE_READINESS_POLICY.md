...
This is a source harness policy. It adds no product code, no package dependency, no target rollout, no external judge requirement, no all-PR browser requirement, and no runtime readiness claim.