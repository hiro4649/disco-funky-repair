...
# Skip NPM Product Bypass Policy

Version: v0.9.4

Keeps CODEX_SKIP_NPM limited to explicit harness-only situations and prevents target rollout mode from leaking into product-relevant PR verification.
