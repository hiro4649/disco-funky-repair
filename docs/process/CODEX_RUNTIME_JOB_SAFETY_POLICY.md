...
# Runtime Job Safety Policy

Version: v0.9.4

Flags runtime job, scheduler, worker, queue, RPC, external API, tx, and batch update risk surfaces that need ownership, idempotency, timeout, retry, and receipt evidence before runtime readiness claims.
