...
const routingCases = [
  ['skill_context_routing_exists_inside_orchestration_capsule', () => buildOrchestrationCapsule().skillContextRouting.schemaVersion === '1.2.2'],
  ...
  ['read_less_preserve_authority_first_reads', () => {
    ...
    return firstReads.includes('AGENTS.md') && firstReads.includes('docs/process/CODEX_HARNESS_MANIFEST.json') && firstReads.includes('docs/process/CODEX_V122_SPEC.md');
  }],
