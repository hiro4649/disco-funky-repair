...
const finalDecisionClosureRepairCases = [
  ...
  ['v123_target_mode_late_reconcile_accepts_safe_output_equivalent_status', () => withEnv({
    CODEX_EVENT_NAME: 'pull_request',
    CODEX_PR_NUMBER: '324',
    CODEX_PR_HEAD_SHA: 'be93d917dfe39f86826e2cc854a5d47a8480b939',
    CODEX_PR_BODY: 'I confirm PR #324 current head be93d917dfe39f86826e2cc854a5d47a8480b939 for merge consideration.\nOwner decision: owner_merge_after_same_head_pass.',
  }, () => v123TargetDecisionClosureNeedsLateReconcile({
    status: 'pass',
    evidenceCapsule: {
      currentHeadEvidence: {
        headSha: 'be93d917dfe39f86826e2cc854a5d47a8480b939',
        qualityGateRunId: '27524694584',
        artifactId: '27524694584-1',
      },
    },
    targetQualityScoreStatus: { status: 'pass' },
  ...
  ['v123_target_mode_late_reconcile_accepts_evidence_equivalent_statuses', () => withEnv({
    CODEX_EVENT_NAME: 'pull_request',
    CODEX_PR_NUMBER: '324',
    CODEX_PR_HEAD_SHA: '5113035fb1e42a721165502b660dc764eb031231',
    CODEX_PR_BODY: 'I confirm PR #324 current head 5113035fb1e42a721165502b660dc764eb031231 for merge consideration.\nOwner decision: owner_merge_after_same_head_pass.',
  }, () => v123TargetDecisionClosureNeedsLateReconcile({
    status: 'pass',
    evidenceCapsule: {
      currentHeadEvidence: {
        headSha: '5113035fb1e42a721165502b660dc764eb031231',
        qualityGateRunId: '27525563434',
        artifactId: '27525563434-1',
      },
    },
    targetQualityScoreStatus: { status: 'pass' },
    targetSafeSummaryRequiredClosureStatus: { status: 'pass' },
    prEvidenceCompactStatus: { status: 'pass' },
  ...
  ['v123_target_mode_late_reconcile_accepts_evidence_capsule_status_alias', () => withEnv({
    CODEX_EVENT_NAME: 'pull_request',
    CODEX_PR_NUMBER: '324',
    CODEX_PR_HEAD_SHA: '37072a831e4e72b026811c4d117bc1e1d3cb1f65',
    CODEX_QUALITY_GATE_RUN_ID: '27528289110',
    CODEX_SAFE_ARTIFACT_ID: '27528289110-1',
    CODEX_PR_BODY: 'I confirm PR #324 current head 37072a831e4e72b026811c4d117bc1e1d3cb1f65 for merge consideration.\nOwner decision: owner_merge_after_same_head_pass.',
  }, () => v123TargetDecisionClosureNeedsLateReconcile({
    status: 'pass',
