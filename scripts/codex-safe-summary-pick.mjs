...
export function summarizeSafeReport(report = {}, safeArtifactPath = '') {
  ...
  return {
    ...
    safeOutputStatus: report.safeOutputStatus?.status || 'unknown',
    targetQualityScoreStatus: report.targetQualityScoreStatus?.status || 'unknown',
    targetMergeReady: report.targetMergeReady === true,
