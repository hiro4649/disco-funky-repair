...
const CASES = [
  ...
  ['backend_product_pr_uses_apps_backend_cwd_v105', gates.buildRemoteProductEvidenceRoutingV105Report, { changedFiles: ['apps/backend/src/app/lib/example.ts'], backendPackagePresent: true, rootPackagePresent: false }, 'remoteProductEvidenceRoutingV105Status', 'pass', 'remote_product_evidence_routing_v105'],
  ['backend_product_pr_records_apps_backend_package_scope_v105', gates.buildRemoteProductEvidenceRoutingV105Report, { changedFiles: ['apps/backend/src/app/lib/example.ts'], backendPackagePresent: true, rootPackagePresent: false }, 'remoteProductEvidenceRoutingV105Status', 'pass', 'remote_product_evidence_routing_v105'],
  ['backend_product_pr_records_backend_npm_test_command_class_v105', gates.buildRemoteProductEvidenceRoutingV105Report, { changedFiles: ['apps/backend/src/app/lib/example.ts'], backendPackagePresent: true, rootPackagePresent: false }, 'remoteProductEvidenceRoutingV105Status', 'pass', 'remote_product_evidence_routing_v105'],
  ['root_package_missing_does_not_run_root_npm_test_v105', gates.buildRemoteProductEvidenceRoutingV105Report, { changedFiles: ['apps/backend/src/app/lib/example.ts'], backendPackagePresent: true, rootPackagePresent: false, rootNpmExecuted: false }, 'remoteProductEvidenceRoutingV105Status', 'pass', 'remote_product_evidence_routing_v105'],
  ['root_package_missing_classified_as_command_scope_mismatch_v105', gates.buildRemoteProductEvidenceRoutingV105Report, { changedFiles: ['src/example.ts'], backendPackagePresent: false, rootPackagePresent: false, expectCommandScopeMismatch: true }, 'remoteProductEvidenceRoutingV105Status', 'pass', 'remote_product_evidence_routing_v105'],
  ['formal_backend_evidence_required_for_backend_product_pr_v105', gates.buildRemoteProductEvidenceRoutingV105Report, { changedFiles: ['apps/backend/src/app/lib/example.ts'], backendPackagePresent: true, rootPackagePresent: false }, 'remoteProductEvidenceRoutingV105Status', 'pass', 'remote_product_evidence_routing_v105'],
  ['remote_product_safe_artifacts_record_backend_scope_v105', gates.buildRemoteProductSafeArtifactsScopeV105Report, {}, 'remoteProductSafeArtifactsScopeV105Status', 'pass', 'remote_product_evidence_routing_v105'],
  ['target_hotfix_preservation_backend_cwd_across_rollout_v105', gates.buildTargetHotfixPreservationReport, {}, 'targetHotfixPreservationStatus', 'pass', 'remote_product_evidence_routing_v105'],
  ['reason_summary_ignores_optional_legacy_when_target_quality_pass_v105', gates.buildReasonSummaryAggregationV105Report, {}, 'reasonSummaryAggregationV105Status', 'pass', 'remote_product_evidence_routing_v105'],
  ['reason_summary_active_v105_failure_still_blocks_v105', gates.buildReasonSummaryAggregationV105Report, { activeV105Fail: true }, 'reasonSummaryAggregationV105Status', 'pass', 'remote_product_evidence_routing_v105'],
  ['reason_summary_product_verification_failure_still_blocks_v105', gates.buildReasonSummaryAggregationV105Report, { productVerificationFail: true }, 'reasonSummaryAggregationV105Status', 'pass', 'remote_product_evidence_routing_v105'],
  ['active_v105_failure_still_blocks', gates.buildActiveLegacySelfTestSummaryReport, { v105Failure: true }, 'activeLegacySelfTestSummaryStatus', 'fail', 'remote_product_evidence_routing_v105'],
  ['parent_v104_preservation_still_passes', gates.buildActiveLegacySelfTestSummaryReport, { v104Failure: true }, 'activeLegacySelfTestSummaryStatus', 'pass', 'remote_product_evidence_routing_v105'],
