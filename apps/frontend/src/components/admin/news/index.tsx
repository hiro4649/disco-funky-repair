    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-gray-500">
          {t('This is the News Management of')} {process.env.NEXT_PUBLIC_APP_NAME}.
        </h3>
        <Button
          color="primary"
          onClick={() => {
      ...
      <Table aria-label="News table">
        <TableHeader>
          ...
          <TableColumn>{t('Image URL')}</TableColumn>
        ...
        <TableBody>
          {news.map((newsItem) => (
            <TableRow key={newsItem.id}>
              ...
              <TableCell>{moment.utc(newsItem.createdAt).format("MM/DD/YYYY HH:mm:ss")}</TableCell>
              <TableCell>
      ...
      <Modal isOpen={isOpen} onClose={onClose} size="lg">
        <ModalContent>
          <ModalHeader>
            {selectedNews ? t('Edit News') : t('Add New News')}
          </ModalHeader>
          <ModalBody>
          ...
          <ModalFooter>
            ...
            >
              {selectedNews ? t('Update') : t('Create')}
            </Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
