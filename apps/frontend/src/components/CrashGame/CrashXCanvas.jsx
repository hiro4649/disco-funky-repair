...
let crashImage, starImg, explosionImage;
if (typeof window !== 'undefined') {
    crashImage = new Image();
    crashImage.src = "/images/crash-game/crash.png";
    starImg = new Image();
    starImg.src = "/images/crash-game/star.png";
    explosionImage = new Image();
    explosionImage.src = "/images/crash-game/boom.png";
}
    ...
    loop() {
        if (this.canvas && this.gameStatus) {
            ...
            if (status === GAME_STATES.InProgress) {
                ...
                this.elapsed = (currentTime - moment.utc(startTime).valueOf()) / 100;
    ...
    draw() {
        if (this.ctx && this.gameStatus && this.canvas) {
            ...
            if (status === GAME_STATES.Over) {
                ...
                const endTime = moment.utc(startTime);
                let timeCount =
                    Math.floor((endTime.valueOf() - currentTime) / 10) / 100;
                if (timeCount < 0) {
