    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="_x32_" x="0px" y="0px" width={`${width ? width : 24}`} height={`${height ? height : 24}`} className={`${className}`} viewBox="0 0 512 512" >
            <g>
                ...
                <path d="M455.016,425.063c0,15.984-12.953,28.938-28.953,28.938H85.938C69.953,454,57,441.047,57,425.063v-2.406   c0-16,12.953-28.953,28.938-28.953h340.125c16,0,28.953,12.953,28.953,28.953V425.063z" />
            </g>
        </svg>
    )
}
