            ...
            <div className="px-3">
                <div className="space-y-3 pt-7 backface-hidden">
                    ...
                    <div className='text-[15px] text-white leading-[22px] pt-2'>
                        <p className='font-semibold text-main pb-[0.8rem]'> {t('Token Allocation')} </p>
                    ...
                    <div className='text-[15px] text-white leading-[22px] pt-2'>
                        <p className='pb-[0.8rem] text-main font-semibold'>{t('Key Features')}</p>
                ...
                <div className='text-[15px] text-white/80 leading-[22px]'>
                    <p className='text-main font-semibold mt-5 mb-[0.8rem]'>{t('Closing Statement')}</p>
