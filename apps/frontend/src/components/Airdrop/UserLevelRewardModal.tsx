                    ...
                    {(onClose) => (
                        <>
                            ...
                            <ModalBody>
                                ...
                                <div className="bg-secondary py-7.5 px-7 rounded-[8px] border border-[#E7E0EC] space-y-1">
                                    {
                                    ...
                                    <div className="text-center text-main text-[10px]">
                                        growth continues ..
                                    </div>
                                </div>
                                <div className="flex justify-center">
                                    <ButtonDefault
                                        ...
                                        leftIconFlag={true}
                                        onClick={() => {  }}
                                        customClasses="bg-main/10 text-main py-1.5 w-3/4 rounded-full border-[0.5px] border-main text-xs shadow"
                                    >
                                    </ButtonDefault>
                                </div>
                            </ModalBody>
