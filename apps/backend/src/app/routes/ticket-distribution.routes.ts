...
router.get('/admin/ticket-distribution', AuthAdmin, asyncHandler(SetTicketDistributeController.getAll.bind(SetTicketDistributeController)));
router.get('/admin/ticket-distribution/:id', AuthAdmin, asyncHandler(SetTicketDistributeController.getById.bind(SetTicketDistributeController)));
