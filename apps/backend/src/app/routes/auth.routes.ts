...
// User Auth Routes
router.post('/user/auth/nonce', authLimiter, asyncHandler(AuthController.issueWalletNonce.bind(AuthController)));
router.post('/user/signup', authLimiter, asyncHandler(AuthController.signup.bind(AuthController)));
...
// Admin Auth Routes
router.post('/admin/signin', authLimiter, asyncHandler(AuthController.signin.bind(AuthController)));
